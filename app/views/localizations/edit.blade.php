...
<div class="row">
    <div class="col-md-12">
        {{ Form::open(['route' => ['localizations.save',$localization->id], 'method' => 'post']) }}

            <div class="form-group">
                <label for="name">Nazwa lokalizacji:</label>
                <input type="text" class="form-control" id="name" name="name" placeHolder="Tutaj wpisz nazwę nowej lokalizacji" value="{{ $localization->name }}">
            </div>

            <div class="form-group">
                <label for="city">Miasto:</label>
                <input type="text" class="form-control" id="city" name="city" placeHolder="miasto" value="{{ $localization->city }}">
            </div>
            <div class="form-group">
                <label for="street">Ulica:</label>
                <input type="text" class="form-control" id="street" name="street" placeHolder="ulica" value="{{ $localization->street }}">
            </div>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-sm">Edytuj lokalizację</button>
            </div>
